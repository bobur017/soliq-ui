    ...
    return (
        <div className={styles.yurAndPhysicalAppeal}>
            ...
            <p className={styles.path}>
                ...
                <span>YSH va JSH yozma murojaatiga (yozma) tushuntirush berish</span>
            </p>
            ...
            <div className="upBox">
                <div className="d-flex">
                    ...
                    <div className="inputs w-100 mr-20">
                        <label >Murojaatning qisqacha mazmuni <span className="withStar">*</span> </label>
                        <input type="text" className="w-100 font-roboto-light"  placeholder="-"/>
                    </div>
...
export default YurAndPhysicalAppeal;
