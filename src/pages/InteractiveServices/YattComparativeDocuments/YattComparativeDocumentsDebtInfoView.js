...
import {updateState} from "../../../redux/actions/yattTaxInfoAction";
import {API_PATH} from "../../../utils/constants";
const YattComparativeDocumentsDebtInfoView = (props) => {
    return (
        props.yattReconciliation &&
        <div className={`${styles.yattComparativeDocumentsDebtInfoView} info-box`}>
            ...
            <div className={`${styles.viewDownload} d-flex w-100`}>
                ...
                props.inn +
                '&name=' +
                btoa(unescape(encodeURIComponent(props.yattInfo?.surName + " " + props.yattInfo?.firstName + " " + props.yattInfo?.middleName))) +
                '&ns10=' +
...
const mapStateToProps = (state) => {
    return {
        ...
        yattReconciliation: state.yatt.yattReconciliation,
    }
}

export default connect(mapStateToProps, {updateState})(YattComparativeDocumentsDebtInfoView);
