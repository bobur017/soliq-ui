...
import {API_PATH, IJARASTORAGE_NAME} from "../../utils/constants";

class AuthRegistrationOfTheAgreement extends Component {
    EIMZO_MAJOR = 3;
    EIMZO_MINOR = 37;
...
export default AuthRegistrationOfTheAgreement;
