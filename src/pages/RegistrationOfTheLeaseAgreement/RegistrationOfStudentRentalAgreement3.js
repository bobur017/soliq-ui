...
const RegistrationOfStudentRentalAgreement3 = (props) => {
    const options = [
        ...
        <div className={styles.registrationOfStudentRentalAgreement2}>
            ...
            <div className={styles.registrationOfStudentRentalAgreement2Part}>
                ...
                <div className={styles.rightPart}>
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <button className={styles.closeBtnTwo}><span className="icon icon-minus-close"></span></button>
                    </div>
                    <div className="d-flex">
                        <div className="inputs w-100 mr-20">
                            <label htmlFor="JSHSHIR121">JSHSHIR <span className="withStar">*</span></label>
                            <input type="text" className="w-100" id="JSHSHIR121" placeholder="-" />
                        </div>
                        <div className="inputs w-100">
                            <label htmlFor="fio12">F.I.SH</label>
                            <input type="text" id="fio12" className="w-100" placeholder="JSHSHIR orqali avtomatik aniqlanadi" />
                        </div>
                    </div>
            ...
            <div className={styles.thirdPart}>
                ...
                <div className={styles.btnGroup}>
                    <button className={styles.paidBtn} onClick={() => props.history.push("/main/electronic-registration/registration-of-the-lease-agreement/completed")}>
                        <span className="icon icon-circleplus" />
...
export default RegistrationOfStudentRentalAgreement3;
