        ...
        <div className={styles.salaryTable}>
            ...
            <div className={styles.selectDays}>
                ...
                <div className="btnGroup">
                    <button className="uploadUpBtn font-roboto-bold mr-20">
            ...
            <div className={`${styles.infoDays} ${styles.mt100}`}>
...
export default SalaryTableRegions;
