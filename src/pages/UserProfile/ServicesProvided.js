                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <div style={{ display: 'inline', cursor: 'pointer' }} onClick={() => onClickService(item)} onMouseLeave={() => onHover()}>
                                                                ...
                                                                <div style={{ margin: 5, width: 10, height: 10, backgroundColor: '#777B82', borderRadius: 8 }}></div>
                                                                <div style={{ margin: 5, width: 10, height: 10, backgroundColor: '#777B82', borderRadius: 8 }}></div>
                                                                <div className={styles3.viewOrDownload} style={currentService?.id == item.id ? { display: 'block' } : { display: 'none' }}>
                                                                    <div className={styles3.viewOrDownloadItem} style={{ marginTop: 0 }}><span className="icon icon-circleplus"></span><span>Tushumni biriktirish</span></div>
                                                                    <div className={styles3.viewOrDownloadItem} style={{ marginTop: 0 }}><span className="icon icon-link"></span><span>Xizmatga o'tkazish</span></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
