...
const YattValueAddedTaxReports = () => {
    const options = [
            ...
            <div className="titleBox ">
                <div className="w-100">
                    <h3 className="titleMain font-roboto-bold">
                        YTT tomonidan taqdim etilgan malumotlar asosida ekektron soliq xisobotlarini tayyorlash va soliq o’rganlariga yuborish
                    </h3>
                </div>
            </div>
            <div className="upBox">
...
export default YattValueAddedTaxReports;
