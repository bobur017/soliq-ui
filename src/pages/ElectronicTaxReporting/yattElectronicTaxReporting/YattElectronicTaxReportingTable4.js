...
const YattElectronicTaxReportingTable4 = () => {
    const options = [
            ...
            <div className={`${styles.tabelsMain}  upBox mt-30`}>
                <div className={styles.mainTabs}>
                    <div  className={styles.Tab}>
                        <Link className={styles.activeTab}>Oxirgilari</Link>
                ...
                <div className={styles.mainTable}>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>2008542737</td>
                            <td>Qabul qilingan oz vaqtida</td>
                            <td>Hozir
                                to’lash</td>
                            <td>01.01.2022  15:23</td>
                            <td>AVTOMAT
...
export default YattElectronicTaxReportingTable4;
