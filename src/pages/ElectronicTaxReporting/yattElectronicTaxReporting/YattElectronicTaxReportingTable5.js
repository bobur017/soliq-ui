...
const YattElectronicTaxReportingTable5 = () => {
    const options = [
            ...
            <div className={`${styles.dupTitleBox}  titleBox`}>
                <div className="w-100">
                    ...
                    <div className="d-flex">
                        ...
                        <div className="inputs w-100 mr-20">
                            <Select options={options} menuContainerStyle={{'zIndex': 999}} placeholder="Yil" />
                        </div>
                        <div className="inputs w-100">
                            <Select options={options} classNamePrefix={"my-custom-react-select"} placeholder="Davr" />
                        </div>
                    </div>
                    <div className="d-flex">
            ...
            <div className={`${styles.tabelsMain}  upBox mt-30`}>
                <div className={styles.mainTabs}>
                    <div  className={styles.Tab}>
                        ...
                        <Link className={styles.activeTab}>Joʼnatilgan</Link>
                        <Link >Rad etilgan</Link>
                        <Link >Xomaki</Link>
                        <Link >Yangi</Link>
                    </div>
                </div>
                <div className={styles.mainTable}>
                    <table>
                        ...
                        <tr>
                            ...
                            <td className="text-center">O'tkazildi kechikish bilan
                                <Link className={styles.redLink}>Требует уточнения в ГНИ</Link>
                            </td>
                            <td>01.01.2022  15:23</td>
                            ...
                            <td className="text-center">
                                ...
                                <div className={styles.control}>
                                    ...
                                    <button><span className="icon icon-upload"/>Excel faylni yuklash</button>
                                </div>
                            </td>
                        </tr>
...
export default YattElectronicTaxReportingTable5;
